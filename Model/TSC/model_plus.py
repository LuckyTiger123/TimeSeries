...
for i in (range(1, 9)):
    ...
    while file_name:
        ...
        # log_file.writelines('train file {}\'s level {} has been read in\r'.format(file_name, i))
...
for j in range(8):
    ...
    for item in train_list[j]:
        ...
        dist_list_label_pair.append([level_label, np_label])
        print('train item of level {} has caled the dist.'.format(level_label))
...
for epoch in range(100):
    ...
    for item in dist_list_label_pair:
        np_label = item[1]
        level_label = item[0]
...
for item in dist_list_label_pair:
    ...
    if label_pre == level_label:
        acc_num += 1
    total_num += 1
    # print('test label {} with result {}'.format(level_label, label_pre))
