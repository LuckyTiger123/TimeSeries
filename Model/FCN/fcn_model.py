...
def get_1D_upsampling_weight(in_channels, out_channels, kernel_size):
    factor = (kernel_size + 1) // 2
    if kernel_size % 2 == 1:
        center = factor - 1
    else:
...
class FCN8s(nn.Module):
    def __init__(self, n_class=9):
        ...
        self.pool4 = nn.MaxPool1d(2, stride=2, ceil_mode=True)  # 1/16
        ...
        self.pool5 = nn.MaxPool1d(2, stride=2, ceil_mode=True)  # 1/32

        # fc6
        self.fc6 = nn.Conv1d(512, 4096, 7)
        self.relu6 = nn.ReLU(inplace=True)
        self.drop6 = nn.Dropout()

        # fc7
        self.fc7 = nn.Conv1d(4096, 4096, 1)
        self.relu7 = nn.ReLU(inplace=True)
        self.drop7 = nn.Dropout()

        self.score_fr = nn.Conv1d(4096, n_class, 1)
        self.score_pool3 = nn.Conv1d(256, n_class, 1)
    ...
    def _initialize_weights(self):
        for m in self.modules():
            ...
            if isinstance(m, nn.ConvTranspose1d):
                ...
                initial_weight = get_1D_upsampling_weight(
